            ...
            child: Column(
              children: [
                ...
                AppTextFormField(
                  ...
                  controller: _codeTec,
                  validator: Validatorless.required('É informação obrigatório'),
                ),
                AppTextFormField(
                ...
                AppCalendarButton(
                  ...
                  setDate: (value) =>
                      widget._clientAddEditController.dateDueHealthPlan = value,
                  isBirthDay: false,
                ),
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    if (formValid) {
                      ...
                      // );
                      var healthPlanModel = HealthPlanModel(
                        id: widget.healthPlanModel?.id,
                        healthPlanType: healthPlanTypeSelected!,
                        code: _codeTec.text,
                        description: _descriptionTec.text,
                      ...
                      Get.back(result: healthPlanModel);
                    }
                  },
